...
public class RoleServiceTest extends TestUtilities {
    ...
    @Test
    void getOneTest() {
        Mockito.when(repositoryMock.findById(1)).thenReturn(Optional.of(new Role()));
    ...
    void addTest() {
        ...
        Assertions.assertTrue(service.add(new RoleDTO(1)), MESSAGE_ERROR);
    }

    @Test
    void addDupeTest() {
        Mockito.when(repositoryMock.existsById(1)).thenReturn(true);
        Assertions.assertFalse(service.add(new RoleDTO(1)), MESSAGE_ERROR);
    }
    ...
    void updateExceptionTest() throws Exception {
        ...
        Assertions.assertFalse(service.update(1, new RoleDTO(1)), MESSAGE_ERROR);
    }
    @Test
    void updateTest() throws Exception {
        Mockito.when(repositoryMock.findById(1)).thenReturn(Optional.of(new Role()));
        Assertions.assertTrue(service.update(1,new RoleDTO(1)), MESSAGE_ERROR);
    }
    ...
    @Test
    void deleteTest() {
        Mockito.when(repositoryMock.existsById(2)).thenReturn(true);
